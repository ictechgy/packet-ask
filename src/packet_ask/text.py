...
_EN = {
    ...
    "policy_lexical_limit": "This gate is a fixed word list: it also blocks review-only wording that contains those words, and a rephrased request passes it.",
...
_KO = {
    ...
    "policy_lexical_limit": "이 게이트는 고정 어휘 목록입니다. 그 단어를 담은 검토 전용 문장도 막고, 표현을 바꾼 요청은 통과합니다.",
