...
_EN = {
    ...
    "surface_empty": ".packet-ask-surface exists but declares nothing. Remove it or add a path.",
    "surface_bytes": ".packet-ask-surface exceeded its byte cap.",
    "surface_entries": ".packet-ask-surface declared too many paths.",
    "surface_encoding": ".packet-ask-surface must be UTF-8.",
    "surface_symlink": ".packet-ask-surface must not be a symlink.",
    "ledger_absolute": "PACKET_ASK_LEDGER must be an absolute path.",
    "ledger_worktree": "PACKET_ASK_LEDGER must not point inside the git worktree.",
    "ledger_symlink": "PACKET_ASK_LEDGER must not be a symlink.",
    "ledger_owner": "PACKET_ASK_LEDGER must be owned by the current user.",
    "ledger_write": "The egress ledger could not be written, so no vendor ran.",
    "ledger_result_warning": "The result line could not be appended to the ledger.",
    "ledger_summary_unset": "PACKET_ASK_LEDGER is not set, so there is no ledger to summarize.",
    "ledger_summary_read": "The ledger could not be read.",
    "ledger_summary_bytes": "The ledger is larger than the summary limit.",
    "ledger_line_bytes": "The egress ledger entry exceeded its byte cap.",
    "include_files_mode": "Only research accepts --include-files. Use --files instead.",
    ...
    "policy_lexical_limit": "This gate is a fixed word list: a question that only asks for a review is also blocked when it contains one of those words, and a rephrased request passes it.",
    ...
    "skill_read_failed": "Could not read the existing SKILL.md, so it was left alone.",
    "skill_write_failed": "Could not write SKILL.md.",
    "skill_home_failed": "Skill not installed for {name}: {reason}",
    ...
    "redaction_leftovers_at": "Sensitive data remained after verification: {kinds} (in {name})",
    "redaction_leftovers_assembled": "Sensitive data remained after verification in the assembled packet: {kinds}. Every item passed on its own, so the trigger is outside item bodies — check selected file names and how items join, not only file contents.",
    ...
    "provider_cli_untrusted": "{name} CLI exists but failed trusted owner/mode validation.",
...
_KO = {
    ...
    "surface_empty": ".packet-ask-surface 가 있는데 아무것도 선언하지 않았습니다. 지우거나 경로를 넣으세요.",
    "surface_bytes": ".packet-ask-surface 가 byte 상한을 넘었습니다.",
    "surface_entries": ".packet-ask-surface 가 너무 많은 경로를 선언했습니다.",
    "surface_encoding": ".packet-ask-surface 는 UTF-8 이어야 합니다.",
    "surface_symlink": ".packet-ask-surface 는 심링크일 수 없습니다.",
    "ledger_absolute": "PACKET_ASK_LEDGER 는 절대 경로여야 합니다.",
    "ledger_worktree": "PACKET_ASK_LEDGER 는 git 워크트리 안을 가리킬 수 없습니다.",
    "ledger_symlink": "PACKET_ASK_LEDGER 는 심링크일 수 없습니다.",
    "ledger_owner": "PACKET_ASK_LEDGER 는 현재 사용자 소유여야 합니다.",
    "ledger_write": "발송 대장을 기록하지 못해 벤더를 실행하지 않았습니다.",
    "ledger_result_warning": "대장에 결과 줄을 덧붙이지 못했습니다.",
    "ledger_summary_unset": "PACKET_ASK_LEDGER 가 비어 있어 요약할 대장이 없습니다.",
    "ledger_summary_read": "대장을 읽지 못했습니다.",
    "ledger_summary_bytes": "대장이 요약 상한보다 큽니다.",
    "ledger_line_bytes": "발송 대장 한 줄이 byte 상한을 넘었습니다.",
    "include_files_mode": "--include-files 는 research 만 받습니다. --files 를 쓰세요.",
    ...
    "policy_lexical_limit": "이 게이트는 고정 어휘 목록입니다. 검토만 요청하는 문장도 그 단어 중 하나를 담으면 막히고, 표현을 바꾼 요청은 통과합니다.",
    ...
    "skill_read_failed": "기존 SKILL.md 를 읽지 못해서 그대로 두었습니다.",
    "skill_write_failed": "SKILL.md 를 쓰지 못했습니다.",
    "skill_home_failed": "스킬을 설치하지 않았습니다 — {name}: {reason}",
    ...
    "redaction_leftovers_at": "재검증에서 민감 값이 남았습니다: {kinds} ({name})",
    "redaction_leftovers_assembled": "조립된 패킷의 재검증에서 민감 값이 남았습니다: {kinds}. 각 항목은 단독으로 통과했으므로 원인은 항목 본문 밖에 있습니다 — 파일 본문만이 아니라 선택한 파일명과 항목이 이어지는 지점을 확인하세요.",
    ...
    "provider_cli_untrusted": "{name} CLI가 있지만 신뢰 owner/mode 검증에 실패했습니다.",
